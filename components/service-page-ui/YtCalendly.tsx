...
const YtCalendly = () => {
  return (
    <section
      id="calendly"
      className="relative overflow-hidden py-14 text-white sm:py-16 md:py-18"
    >
          ...
          <div className="relative z-10 grid lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div className="relative p-3 md:p-5">
              ...
              <div className="relative overflow-hidden rounded-[24px] border border-white/[0.03] bg-black/30 backdrop-blur-2xl">
                ...
                {/* TOP BAR */}
                <div className="relative z-10 flex items-center justify-between border-b border-white/[0.03] px-5 py-4">
