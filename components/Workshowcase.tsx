...
const Workshowcase = () => {
    ...
    return (
      ...
      <div className="absolute inset-0 pointer-events-none transform-gpu will-change-transform">
                ...
                <div
                    className="absolute left-1/2 top-[42%] h-[1000px] w-[1600px] sm:h-[1500px] sm:w-[2200px] -translate-x-1/2 -translate-y-1/2 blur-[120px] sm:blur-[200px]"
                    style={{
                        background: `
        radial-gradient(
          ellipse at center,
      ...
      `,
                ...
                <div
                    className="absolute left-1/2 top-[52%] h-[600px] w-[900px] sm:h-[900px] sm:w-[1400px] -translate-x-1/2 -translate-y-1/2 blur-[90px] sm:blur-[120px]"
                    style={{
                        background: `
        radial-gradient(
          ellipse,
      ...
      `,
                ...
                {/* LEFT AURORA */}
                <div
                    className="absolute left-[-18%] top-[5%] h-[600px] w-[600px] sm:h-[900px] sm:w-[900px] blur-[120px] sm:blur-[180px]"
                    style={{
                        background:
                ...
                {/* RIGHT AURORA */}
                <div
                    className="absolute right-[-18%] top-[10%] h-[700px] w-[700px] sm:h-[1000px] sm:w-[1000px] blur-[130px] sm:blur-[190px]"
                    style={{
                        background:
                ...
                {/* CENTER ENERGY DISC */}
                <div
                    className="absolute left-1/2 top-[48%] h-[340px] w-[340px] sm:h-[540px] sm:w-[540px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[50px] sm:blur-[80px]"
                    style={{
                        background:
                                ...
                                <div className="group relative overflow-hidden rounded-[24px] sm:rounded-[36px] border border-white/10 bg-black/40">
                                    ...
                                    <div className="relative h-[400px] sm:h-[600px] lg:h-[760px] overflow-hidden">
                                        ...
                                        <Image
                                            ...
                                            alt={filtered[0]?.title || "Featured Project"}
                                            fill
                                    ...
                                    {filtered.slice(1).map((project, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="relative h-[200px] sm:h-[240px] overflow-hidden">
                                                ...
                                                <Image src={project.image} alt={project.title} fill className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" />
