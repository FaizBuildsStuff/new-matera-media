...
>
  {/* BACKGROUND */}
    ...
    <div
      className="
        orb-1 absolute left-[-35%] top-[5%]
        h-[700px] w-[700px]
        rounded-full bg-emerald-400/30

        sm:h-[900px] sm:w-[900px]
        lg:left-[-20%]
        lg:top-[10%]
        lg:h-[1200px]
        lg:w-[1200px]
    ...
    <div
      className="
        orb-2 absolute right-[-35%] top-[0%]
        h-[650px] w-[650px]
        rounded-full bg-green-400/20

        sm:h-[850px] sm:w-[850px]
        lg:right-[-15%]
        lg:top-[5%]
        lg:h-[1000px]
        lg:w-[1000px]
    ...
    <div
      className="
        orb-3 absolute left-1/2 top-[42%]
        h-[400px] w-[500px]
    ...
    <div
      className="
        rotate-slow absolute left-1/2 top-[42%]
        h-[420px] w-[420px]
        -translate-x-1/2 -translate-y-1/2
    ...
    <div
      className="
        rotate-reverse absolute left-1/2 top-[42%]
        h-[300px] w-[300px]
        -translate-x-1/2 -translate-y-1/2
        rounded-full border border-emerald-400/[0.06]
          ...
          >
            ...
            <div
              className="
                ...
                shadow-[0_0_50px_rgba(255,255,255,0.7)]
                transition-all duration-500
